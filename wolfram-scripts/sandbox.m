...
(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](RicciScalarCDT[]+ F[a,b]F[-a,-b]))/.FtoA
...
Print["Writing in terms of torsion"]
...
Print["expanding lagrangian"]


Print["This part is slow, but it breaks if I try to use ApplyParallel"]
...
(* ::Input::Initialization:: *)
maxwell=maxwell//ContractMetric//ToCanonical


(* ::Input::Initialization:: *)
maxwellField=ChangeCovD[maxwell,CDT,CD]//ChristoffelToGradMetric;
...
(* ::Input::Initialization:: *)
einsteinC=ApplyParallel[einstein,{funcPertTtoVec,funcTtoVec,funcPertAtoF, SeparateMetric[metric] ,ToCanonical,ToBasis[cartesian],ToBasis[cartesian]}];
einsteinExpr=ApplyParallel[einsteinC, {funcChristCartZero,TraceBasisDummy,TraceBasisDummy,ComponentArray,ToValues,ToValues,ToCanonical}]
...
maxwellExpr=ApplyParallel[maxwellCa,{ContractMetric,TraceBasisDummy,TraceBasisDummy,ComponentArray,ToValues,ToValues,ToCanonical,SeparateMetric[metric],ToBasis[cartesian],ToBasis[cartesian],TraceBasisDummy,TraceBasisDummy,ToCanonical,ToValues}];
...
DumpSave[FileNameJoin[{directory,"sandboxresults.mx"}],{maxwellCa,maxwellC,maxwellField,maxwellExpr,einstein,einsteinExpr,torsionField,torsionExpr}]
