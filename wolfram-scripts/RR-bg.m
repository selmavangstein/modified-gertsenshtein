...
(* ::Text:: *)
(*RR-term in lagrangian with torsion only in t,y-direction*)
...
(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](RicciScalarCDT[]+\[Lambda] RicciCDT[a,b]RicciCDT[-a,-b]+\[Kappa] F[a,b]F[-a,-b]))/.FtoA
