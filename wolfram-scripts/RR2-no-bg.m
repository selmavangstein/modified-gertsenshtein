...
(* ::Input::Initialization:: *)
DefConstantSymbol[{\[Kappa]2,\[Lambda],\[Alpha]}];


(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](\[Alpha] RicciScalarCDT[]+\[Kappa]2 RicciCDT[-a,-b]RicciCDT[a,b]+ \[Lambda] F[-a,-b]F[a,b]))/.FtoA
...
DumpSave[FileNameJoin[{directory,"results/rr2-no-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
