...
(* ::Input::Initialization:: *)
DefConstantSymbol[{\[Alpha],\[Kappa]5,\[Lambda]}];
...
DumpSave[FileNameJoin[{directory,"results/rr5-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
