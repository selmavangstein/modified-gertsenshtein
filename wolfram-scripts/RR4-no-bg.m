...
(* ::Input::Initialization:: *)
DefConstantSymbol[{\[Kappa]4,\[Alpha],\[Lambda]}];


(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](\[Alpha] RicciScalarCDT[]+\[Kappa]4 RiemannCDT[-a,-b,-c,-d]RiemannCDT[a,b,c,d]+ \[Lambda] F[a,b]F[-a,-b]))/.FtoA
...
(* ::Input::Initialization:: *)
einsteinField=ApplyParallel[einsteinField, {funcNoTorsion,funcLorentz,funcPertAtoF,funcCD,ToCanonical,ContractMetric}];
...
DumpSave[FileNameJoin[{directory,"results/RR4-no-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
