...
(* ::Input::Initialization:: *)
DefConstantSymbol[{\[Alpha],\[Lambda]}];


(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](\[Alpha] RicciScalarCDT[]+ \[Lambda] F[a,b]F[-a,-b]))/.FtoA
...
(* ::Input::Initialization:: *)
torsionField=ChangeCovD[torsionField,CDT,CD]//ChristoffelToGradMetric//ContractMetric;
...
DumpSave[FileNameJoin[{directory,"results/og-no-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
