...
fullySimplify[inputExpr_List,InputRules_]:=Module[{currExpr=inputExpr, simplerExpr},
	currExpr=currExpr/.InputRules;
	currExpr=currExpr/.InputRules;
	currExpr=currExpr/.InputRules;
	...
	NumberOfEquations=Length[currExpr];
	Comment@{"After simplification, we have ",ToString@NumberOfEquations," equations."};	
currExpr];
...
applyMaxwellsEquation[inputExpr_]:=Module[{outputExpr=inputExpr,maxwellRules},
	...
	maxwellRules={
	\!\(\*SuperscriptBox[\(\[Epsilon]x\), 
TagBox[
RowBox[{"(", 
RowBox[{"1", ",", "0", ",", "0", ",", "1"}], ")"}],
Derivative],
MultilineFunction->None]\)[t[],x[],y[],z[]]->Derivative[2,0][\[ScriptB]][t[],z[]]+\!\(\*SuperscriptBox[\(\[Epsilon]z\), 
TagBox[
RowBox[{"(", 
RowBox[{"1", ",", "1", ",", "0", ",", "0"}], ")"}],
Derivative],
...
RowBox[{"1", ",", "0", ",", "1", ",", "0"}], ")"}],
Derivative],
MultilineFunction->None]\)[t[],x[],y[],z[]]->\!\(\*SuperscriptBox[\(\[Epsilon]y\), 
TagBox[
RowBox[{"(", 
RowBox[{"1", ",", "1", ",", "0", ",", "0"}], ")"}],
Derivative],
MultilineFunction->None]\)[t[],x[],y[],z[]],
	\!\(\*SuperscriptBox[\(\[Epsilon]z\), 
TagBox[
RowBox[{"(", 
RowBox[{"1", ",", "0", ",", "1", ",", "0"}], ")"}],
Derivative],
...
simplifyExpr[inputExpr_]:=Module[{outputExpr=inputExpr,eqs,allParts,variables,sols,zeroSolutions,extendedZeroSolutions},
	...
	variables=Select[variables,(!NumberQ[#])&];
	...
	sols=Assuming[Thread[constants!=0],Quiet@Solve[eqs,variables]];
...
applyTrivialSolutions[inputExpr_,constants_List]:=Module[{currExpr=inputExpr,i,simplerExpr,trivialEqs,trivialSols,trivialExpr, trivialVariables,prodElements,zeroFuncs,zeroFuncsRule,dRules},
	...
	While[
		...
		trivialSols=Assuming[Thread[constants!=0],Quiet@Solve[trivialEqs]];
		(*I have only seen this produce one solution, but if not it just picks one*)
