...
(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](RicciScalarCDT[]+ \[Gamma] RicciCDT[-a,-b]F[a,b]+\[Lambda] F[-a,-b]F[a,b]))/.FtoA
...
DumpSave[FileNameJoin[{directory,"results/rf-no-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
