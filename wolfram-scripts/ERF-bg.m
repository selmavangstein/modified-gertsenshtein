...
(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](RicciScalarCDT[]+\[Alpha] epsilonmetric[-a,-b,-c,-d]RicciCDT[a,b]F[c,d]+ \[Lambda] F[-a,-b]F[a,b]))/.FtoA
...
DumpSave[FileNameJoin[{directory,"results/erf-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
