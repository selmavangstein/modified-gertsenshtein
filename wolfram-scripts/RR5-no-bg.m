...
(* ::Input::Initialization:: *)
DefConstantSymbol[{\[Kappa]5,\[Alpha],\[Lambda]}];


(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](\[Alpha] RicciScalarCDT[]+\[Kappa]5 RiemannCDT[-a,-b,-c,-d]RiemannCDT[a,c,b,d]+ \[Lambda] F[-a,-b]F[a,b]))/.FtoA
...
DumpSave[FileNameJoin[{directory,"results/rr5-no-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
