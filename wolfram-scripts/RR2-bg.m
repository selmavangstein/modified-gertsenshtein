...
(* ::Input::Initialization:: *)
DefConstantSymbol[{\[Kappa]2,\[Alpha],\[Lambda] }];
...
DumpSave[FileNameJoin[{$ThisDirectory,"results/rr2-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
