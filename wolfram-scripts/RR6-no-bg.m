...
(* ::Input::Initialization:: *)
DefConstantSymbol[{\[Kappa]6,\[Alpha],\[Lambda]}];


(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](\[Alpha] RicciScalarCDT[]+\[Kappa]6 RiemannCDT[-a,-b,-c,-d]RiemannCDT[c,d,a,b] +\[Lambda] F[-a,-b]F[a,b]))/.FtoA
...
DumpSave[FileNameJoin[{directory,"results/rr6-no-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
