...
(* ::Input::Initialization:: *)
DefConstantSymbol[{\[Alpha],\[Kappa]1,\[Kappa]2,\[Kappa]3,\[Kappa]4,\[Kappa]5,\[Kappa]6,\[Beta]1,\[Beta]2,\[Beta]3,\[Gamma],\[Lambda]}];


(* ::Input::Initialization:: *)
\[ScriptCapitalL]=(Sqrt[-Detmetric[]](\[Alpha] RicciScalarCDT[]+\[Kappa]1 RicciScalarCDT[]^2+ \[Kappa]2 RicciCDT[-a,-b]RicciCDT[a,b] +\[Kappa]3 RicciCDT[-a,-b]RicciCDT[b,a]+\[Kappa]4 RiemannCDT[-a,-b,-c,-d]RiemannCDT[a,b,c,d]+\[Kappa]5 RiemannCDT[-a,-b,-c,-d]RiemannCDT[a,c,b,d]+\[Kappa]6 RiemannCDT[-a,-b,-c,-d]RiemannCDT[c,d,a,b]+\[Beta]1 TorsionCDT[-a,-b,-c]TorsionCDT[a,b,c]+\[Beta]2 TorsionCDT[-a,-b,-c]TorsionCDT[b,a,c]+\[Beta]3 TorsionCDT[b,-a,-b]TorsionCDT[c,a,-c]+\[Gamma] RicciCDT[-a,-b]F[a,b]+\[Lambda] F[-a,-b]F[a,b]))/.FtoA
...
(* ::Input::Initialization:: *)
funcNoTorsion[expr_]:=expr/.TorsionCDT->Zero;
linearizedAction=ApplyParallel[linearizedAction,{funcNoTorsion,ToCanonical,ContractMetric}];
...
(* ::Input::Initialization:: *)
torsionField=ApplyParallel[torsionField,{funcNoTorsion,funcLorentz,funcCD,ToCanonical,ContractMetric}];
...
(* ::Input::Initialization:: *)
einsteinField=ApplyParallel[einsteinField, {funcNoTorsion,funcPertAtoF,funcLorentz,funcCD,ToCanonical,ContractMetric}];
...
(* ::Input::Initialization:: *)
maxwellField=ApplyParallel[maxwellField,{funcNoTorsion,funcLorentz,funcCD,ToCanonical,ContractMetric}];
...
(* ::Input::Initialization:: *)
torsionC=ApplyParallel[torsionField,{funcPertTtoVec,ToCanonical,ToBasis[cartesian]}]
...
(* ::Input::Initialization:: *)
einsteinC=ApplyParallel[einsteinField,{funcPertTtoVec,funcPertAtoF, SeparateMetric[metric] ,ToCanonical,ToBasis[cartesian]}];
...
DumpSave[FileNameJoin[{directory,"results/all-no-bg-results.mx"}],{\[ScriptCapitalL],maxwellCurl,maxwellC,maxwellField,maxwellExpr,einsteinField,einsteinExpr,torsionField,torsionExpr}]
